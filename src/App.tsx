...
export default function App() {
  ...
  if (carregando) {
    return (
      <div style={{ backgroundColor: '#121212', minHeight: '100vh', padding: '20px', fontFamily: 'sans-serif', maxWidth: '450px', margin: '0 auto', color: '#fff' }}>
  ...
  return (
    <div style={{
      ...
      <h1 style={{ textAlign: 'center', fontSize: '24px', marginBottom: '30px' }}>Agendamento Online 🗓️</h1>
